...
def main():
    ...
    with LOG_FILE.open('r') as file:
        for line in file:
            ...
            if parsed_line is None:  # If the line is invalid
                invalid_lines += 1
                continue
       
            timestamp, level, service, message = parsed_line
       
            # Normalize the level
            level = normalize_level(level)
       
            # Count the valid levels
    ...
    with OUTPUT_REPORT.open('w') as output_file:
